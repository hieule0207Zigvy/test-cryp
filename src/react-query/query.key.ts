...
const createBasicListKey = <ListParams = unknown>({
  scope,
}: {
  scope: QueryKeysEnum;
}) => {
  const queryKeyFactory = {
    ...
    invalidateListsKey: () =>
      [
        { ...queryKeyFactory.invalidateAllKey[0], entity: "lists" },
      ] as QueryKeyTypes,
    /**
    ...
    list: (params?: ListParams) =>
      [
        { ...queryKeyFactory.invalidateListsKey()[0], params },
      ] as QueryKeyTypes<ListParams>,
    /**
     * Used to invalidate all detail queries
     */
    invalidateDetailsKey: () =>
      [
        { ...queryKeyFactory.invalidateAllKey[0], entity: "details" },
      ] as QueryKeyTypes,
    /**
     * Detail query key
     */
    detail: (id: string) =>
      [{ ...queryKeyFactory.invalidateDetailsKey()[0], id }] as QueryKeyTypes,
  };
